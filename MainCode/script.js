...
function applyRandomTheme() {if (!MY_FAVORITE_THEMES.length) return;
...
function initBackground() {// 1. Read theme colors and structural personality tokens
...
function initScrollReveal() {const reveals = document.querySelectorAll('.reveal');
...
function initCategoryFilter() {const buttons  = document.querySelectorAll('.category-btn');
