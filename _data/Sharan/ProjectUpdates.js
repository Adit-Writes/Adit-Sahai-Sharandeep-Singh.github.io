// _data/Sharan/ProjectUpdates.js
// Loads all JSON files from _data/Sharan/ProjectUpdates/ folder
const fs   = require('fs');
...
module.exports = function() {
    const dir = path.join(__dirname, 'ProjectUpdates');
    ...
    return fs.readdirSync(dir)
        ...
        .map(f => {
            try {
                ...
                console.warn(`[Sharan/ProjectUpdates] Could not parse ${f}:`, e.message);
                return null;
            }
        })
        .filter(Boolean);
